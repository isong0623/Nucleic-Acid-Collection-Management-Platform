...
public class LFilePickerActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mRecylerView = (EmptyRecyclerView) getWindow().getDecorView().findViewById(R.id.recylerview);
        mTvPath = (TextView) getWindow().getDecorView().findViewById(R.id.tv_path);
        mTvBack = (TextView) getWindow().getDecorView().findViewById(R.id.tv_back);
        mBtnAddBook = (Button) getWindow().getDecorView().findViewById(R.id.btn_addbook);
        mEmptyView = getWindow().getDecorView().findViewById(R.id.empty_view);
        mToolbar = (Toolbar) getWindow().getDecorView().findViewById(R.id.toolbar);
        if (mParamEntity.getAddText() != null) {
            mBtnAddBook.setText(mParamEntity.getAddText());
        }
    }
