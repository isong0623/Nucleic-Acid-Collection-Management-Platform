 ...
 * a {@link java.util.regex2.Matcher} object that can match arbitrary {@linkplain
 ...
 * boolean b = m.{@link java.util.regex2.Matcher#matches matches}();</pre></blockquote>
 *
 ...
 * concurrent threads.  Instances of the {@link java.util.regex2.Matcher} class are not safe for
 * such use.
 *
 *
 ...
 *    by the {@link java.util.regex2.Matcher} class: Repeated invocations of the {@link
 *    java.util.regex2.Matcher#find find} method will resume where the last match left off,
        ...
        implements java.io.Serializable
{
     ...
     * @throws java.util.regex2.PatternSyntaxException
     ...
     */
    public java.util.regex2.Matcher matcher(CharSequence input) {
        if (!compiled) {
            synchronized(this) {
                if (!compiled)
                    compile();
        ...
        java.util.regex2.Matcher m = new java.util.regex2.Matcher(this, input);
        return m;
    }
    ...
    public static boolean matches(String regex, CharSequence input) {
        ...
        java.util.regex2.Matcher m = p.matcher(input);
        return m.matches();
    }
    ...
    public String[] split(CharSequence input, int limit) {
        ...
        java.util.regex2.Matcher m = matcher(input);
     ...
     */
    private java.util.regex2.PatternSyntaxException error(String s) {
    ...
    static class Node extends Object {
         ...
         */
        boolean match(java.util.regex2.Matcher matcher, int i, CharSequence seq) {
            matcher.last = i;
    ...
    static class LastNode extends Node {
         ...
         */
        boolean match(java.util.regex2.Matcher matcher, int i, CharSequence seq) {
            if (matcher.acceptMode == java.util.regex2.Matcher.ENDANCHOR && i != matcher.to)
                return false;
            matcher.last = i;
            matcher.groups[0] = matcher.first;
            matcher.groups[1] = matcher.last;
    ...
    static final class Curly extends Node {
        ...
        boolean match0(java.util.regex2.Matcher matcher, int i, int j, CharSequence seq) {
            if (j >= cmax) {
        ...
        // i is the index to start matching at
        // j is the number of atoms that have matched
        boolean match1(java.util.regex2.Matcher matcher, int i, int j, CharSequence seq) {
            for (;;) {
        ...
        boolean match2(java.util.regex2.Matcher matcher, int i, int j, CharSequence seq) {
            for (; j < cmax; j++) {
                if (!atom.match(matcher, i, seq))
                    break;
                if (i == matcher.last)
    ...
    static final class GroupHead extends Node {
        ...
        boolean matchRef(java.util.regex2.Matcher matcher, int i, CharSequence seq) {
            int save = matcher.locals[localIndex];
    ...
    static class Loop extends Node {
        ...
        boolean matchInit(java.util.regex2.Matcher matcher, int i, CharSequence seq) {
    ...
    static final class Bound extends Node {
        ...
        int check(java.util.regex2.Matcher matcher, int i, CharSequence seq) {
            int ch;
            boolean left = false;
            int startIndex = matcher.from;
            int endIndex = matcher.to;
     ...
     */
    private static boolean hasBaseCharacter(java.util.regex2.Matcher matcher, int i,
                                            CharSequence seq)
    {
