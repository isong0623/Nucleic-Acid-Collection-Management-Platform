 ...
 * character sequence} by interpreting a {@link java.util.regex2.Pattern}.
 *
 * <p> A matcher is created from a pattern by invoking the pattern's {@link
 * java.util.regex2.Pattern#matcher matcher} method.  Once created, a matcher can be used to
...
public final class Matcher implements java.util.regex2.MatchResult {

    /**
     * The Pattern object that created this Matcher.
     */
    java.util.regex2.Pattern parentPattern;
     ...
     */
    Matcher(java.util.regex2.Pattern parent, CharSequence text) {
     ...
     */
    public java.util.regex2.Pattern pattern() {
        return parentPattern;
    }

    /**
     * Returns the match state of this matcher as a {@link java.util.regex2.MatchResult}.
